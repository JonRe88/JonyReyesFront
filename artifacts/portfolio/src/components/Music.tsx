...
export function Music() {
  return (
    <section id="music" className="py-24 bg-card/30 relative border-y border-white/5">
          ...
          >
            ...
            <div className="relative z-10 flex flex-col sm:flex-row gap-8 items-center sm:items-stretch">
              ...
              <div className="flex flex-col justify-center text-center sm:text-left">
                ...
                <h3 className="text-3xl sm:text-4xl font-bold mb-3 font-display">Jony Reyes</h3>
